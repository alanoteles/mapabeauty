...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12 align-right margin-top-10">
            <a href="" data-route="/admin/tabelas-de-apoio/tipo-de-material/create"><button class="btn btn-sm btn-success">Novo tipo de material</button></a>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table id="sample-table-1" class="table table-striped table-bordered table-hover no-margin">
                ...
                <tr>
                    ...
                    <th style="width: 70%;">Tipo de material</th>
                ...
                <tr>
                    ...
                    <td class="nome-grupo" style="width: 70%;">
                        <a href="" data-route="/admin/tabelas-de-apoio/tipo-de-material/{{$resultado->type_id}}/edit">
                            {{ $res['type'] }}
                        </a>
                    </td>
                    ...
                    <td class="acoes center">
                        <div class="btn-group">
                            <a href="#" class="btn btn-xs btn-grey remover-item-lista excluir" data-id="{{$resultado->type_id}}">
