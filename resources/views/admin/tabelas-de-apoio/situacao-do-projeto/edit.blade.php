...
@section('title','Situação do Projeto')
...
@section('content')
    ...
    {{ Form::open(
       array(
           'url'   => App::getLocale() . '/admin/tabelas-de-apoio/situacao-do-projeto/' .  (isset($resultado->id) ? $resultado->id : '' ),
           'name'  => 'frm',
           'id'    => 'frm',
    ...
    {{ Form::hidden('model', (isset($model) ? $model : ''), array('id' => 'model')) }}
        ...
        <div class="col-xs-12 botoes-pj-pf">
            @if(isset($resultado->id))
                <button type="button" class="btn remover-item margin-right-20 margin-left-2 excluir" data-id="{{$resultado->project_situation_id}}">
                    Excluir situação
                </button>
            @endif

            <a href="" data-route="/admin/tabelas-de-apoio/situacao-do-projeto"  class="btn cancelar btn-sm font-size-15 margin-right-2" style="padding: 3px 10px 4px 10px;">Cancelar</a>
            ...
            <div class="tab-content">
                ...
                <div id="acesso" class="tab-pane  margin-top-45  margin-bottom-45 active">
                    ...
                    <div class="form-group fotm-tab">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Situação *</label>
                        <div class="col-sm-6">
                ...
                @if(isset($resultado))
                    <div id="aba-traducoes" class="tab-pane margin-top-45 margin-bottom-45">
                        ...
                        <div class="form-group fotm-tab">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Traduções desse situação </label>
