...
@section('content')
    ...
    {{ Form::open(
       array(
           'url'   => App::getLocale() . '/admin/tabelas-de-apoio/editoria-da-noticia/' .  (isset($resultado->id) ? $resultado->id : '' ),
           'name'  => 'frm',
           'id'    => 'frm',
    ...
    {{ Form::hidden('model', (isset($model) ? $model : ''), array('id' => 'model')) }}
        ...
        <div class="col-xs-12 botoes-pj-pf">
            ...
            <a href="" data-route="/admin/tabelas-de-apoio/editoria-da-noticia"  class="btn cancelar btn-sm font-size-15 margin-right-2" style="padding: 3px 10px 4px 10px;">Cancelar</a>
            ...
            <div class="tab-content">
                ...
                @if(isset($resultado))
                    <div id="aba-traducoes" class="tab-pane margin-top-45 margin-bottom-45">
                        ...
                        <div class="form-group fotm-tab">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Traduções dessa editoria </label>
