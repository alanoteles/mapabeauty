...
@section('content')
    ...
    {{ Form::open(
       array(
           'url'   => App::getLocale() . '/admin/tabelas-de-apoio/tag/' .  (isset($resultado->id) ? $resultado->id : '' ),
           'name'  => 'frm',
           'id'    => 'frm',
    ...
    {{ Form::hidden('model', (isset($model) ? $model : ''), array('id' => 'model')) }}
        ...
        <div class="col-xs-12 botoes-pj-pf">
            ...
            <a href="" data-route="/admin/tabelas-de-apoio/tag"  class="btn cancelar btn-sm font-size-15 margin-right-2" style="padding: 3px 10px 4px 10px;">Cancelar</a>
            ...
            <div class="tab-content">
                ...
                <div id="acesso" class="tab-pane  margin-top-45  margin-bottom-45 active">
                    ...
                    <div class="form-group fotm-tab">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nome da tag *</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group fotm-tab">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Objetos vinculados : </label>

                        @if(!empty($total_object_tags))
                            <div class="col-sm-6"><p class="lead">{{ $total_object_tags }}</p></div>
                        @else
                            <div class="col-sm-6"><p class="lead">Nenhum objeto vinculado a essa TAG</p></div>
                        @endif
                    </div>

                    <div class="form-group fotm-tab">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Notícias vinculadas : </label>

                        @if(!empty($total_news_tags))
                            <div class="col-sm-6"><p class="lead">{{ $total_news_tags }}</p></div>
                        @else
                            <div class="col-sm-6"><p class="lead">Nenhuma notícia vinculada a essa TAG</p></div>
                        @endif
                    </div>
                ...
                @if(isset($resultado))
                    <div id="aba-traducoes" class="tab-pane margin-top-45 margin-bottom-45">
                        ...
                        <div class="form-group fotm-tab">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Traduções </label>
...
<script src="{{asset('admin/js/tag.js')}}"></script>
