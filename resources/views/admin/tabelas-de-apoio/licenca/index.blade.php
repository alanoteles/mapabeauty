...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12 align-right margin-top-10">
            <a href="" data-route="/admin/tabelas-de-apoio/licenca/create">
        ...
        <div class="table-responsive">
            <table id="sample-table-1" class="table table-striped table-bordered table-hover no-margin">
                ...
                <tr>
                    ...
                    <th style="width: 70%;">Nome da licença</th>
                ...
                <tr>
                    ...
                    <td class="nome-grupo" style="width: 70%;">
                        <a href="" data-route="/admin/tabelas-de-apoio/licenca/{{$resultado->license_id}}/edit">
                            {{ $res['name'] }}
                        </a>
                    </td>
                    ...
                    <td class="acoes center">
                        <div class="btn-group">
                            <a href="#" class="btn btn-xs btn-grey remover-item-lista excluir" data-id="{{$resultado->license_id}}">
