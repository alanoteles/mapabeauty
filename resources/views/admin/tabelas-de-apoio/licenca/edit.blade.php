...
@section('content')
    ...
    {{ Form::open(
       array(
           'url'   => App::getLocale() . '/admin/tabelas-de-apoio/licenca/' .  (isset($resultado->id) ? $resultado->id : '' ),
           'name'  => 'frm',
           'id'    => 'frm',
    ...
    {{ Form::hidden('model', (isset($model) ? $model : ''), array('id' => 'model')) }}
        ...
        <div class="col-xs-12 botoes-pj-pf">
            ...
            <a href="" data-route="/admin/tabelas-de-apoio/licenca"  class="btn cancelar btn-sm font-size-15 margin-right-2" style="padding: 3px 10px 4px 10px;">Cancelar</a>
            ...
            <div class="tab-content">
                ...
                <div id="acesso" class="tab-pane  margin-top-45  margin-bottom-45 active">
                    ...
                    <div class="form-group fotm-tab">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nome da licença *</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group fotm-tab">
                        ...
                        <div class="col-sm-8">
                            {{--<textarea name="summary" id="summary" class="form-control descricao-grupo" placeholder="" >--}}
                                {{--{{ (isset($resultado->summary) ? $resultado->summary : '')  }}--}}
                            {{--</textarea>--}}
                            {{ Form::textarea('summary', (isset($resultado->summary) ? $resultado->summary : ''), array('class' => 'col-sm-12', 'id' => 'summary')) }}
                        </div>
