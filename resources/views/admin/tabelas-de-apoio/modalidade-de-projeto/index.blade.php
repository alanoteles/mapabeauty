        ...
        <div class="table-responsive">
            <table id="sample-table-1" class="table table-striped table-bordered table-hover no-margin">
                ...
                <tr>
                    ...
                    <td class="nome-grupo" style="width: 70%;"><a href="" data-route="/admin/tabelas-de-apoio/modalidade-de-projeto/{{ isset($resultado->project_type_id) ? $resultado->project_type_id : $resultado->id }}/edit">{{ $resultado_array['name'] }}</a></td>
                    <td class="hidden-480 situacao situacao-clientes">
                        <select class="form-control transparent status" name="status" data-id="{{ isset($resultado->project_type_id) ? $resultado->project_type_id : $resultado->id }}">
                    ...
                    <td class="acoes center">
                        <div class="btn-group">
                            <a href="#" class="btn btn-xs btn-grey remover-item-lista excluir" data-id="{{ isset($resultado->project_type_id) ? $resultado->project_type_id : $resultado->id }}">
